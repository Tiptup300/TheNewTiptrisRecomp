...
A work-in-progress native PC port of **The New Tetris (N64)** built with
[N64: Recompiled](https://github.com/N64Recomp/N64Recomp) — static recompilation
of the game's MIPS code to C, run on a modern runtime + renderer.
...
- Target ROM: **The New Tetris (U)** — sha1 `83fff25e82181a6993f28c91b9eeb8430396838b`, crc32 `528a07fa`
