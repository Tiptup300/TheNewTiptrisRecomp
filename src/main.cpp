// The New Tetris : Recompiled — application entry point.
...
int main(int argc, char** argv) {
...
#endif
    recompui::programconfig::set_program_name("The New Tetris : Recompiled");
    ...
    std::filesystem::path config_dir =
        std::filesystem::path(SDL_GetPrefPath("N64Recomp", "TheNewTetris"));
    ...
    game.display_name = "The New Tetris";
